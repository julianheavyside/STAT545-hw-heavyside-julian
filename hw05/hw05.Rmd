...
Let's select just a handful of countries (Sierra Leone, Mali, Chad, Togo, and Libya), and add size and colour aesthetics to the points. We can add a colour aes to indicate per capita gdp, and a size to indicate population size
